...
export default {
  Categories: 'ምድቦች',
  Filters: 'ማጣሪያዎች',
  Social: 'ማህበራዊ ድረገጾቻቺን',
  'View All': 'ኣሳይ',
  'Number of Results': 'የተገጙ ውጤቶች ብዛት ',
  'search with in these results:': 'በእነዚህ ውጤቶች ውስጥ ይፈልጉ',
  Brand: 'የምርት ስም',
  'Sort Subcategory by': 'ምድቡን ደርድር',
  'Name from A to Z': 'በስም ከ A አስከ Z',
  'Name from Z to A': 'በስም ከ Z አስከ A',
  'Price Range': 'የዋጋ ክልል',
  to: 'አስከ',
  min: 'ዝቀተኛ',
  max: 'ክፍተኛ',
  ...
  'Sort by': 'ለመዘርዘር',
  'Products found': 'የተገኙ መገልገያዎች',
  'About us': 'ስለኛ',
  'Who we are': 'እኛ ማነን',
  'Quality in the details': 'ጥራት በተግባር',
  ...
  'Contact us': 'መልዕክት ይላኩልን',
  'Payment & Delivery': 'ክፍያ እና ማጓጓዣ',
  'Purchase terms': 'የግዢ ስምምነት',
  Guarantee: 'ዋስትና',
  ...
  Done: 'Done',
  'General Laboratory': 'ጠቅላላ ላብራቶሪ',
  'Medical Imagery': 'ሜዲካል ኢሜጀሪ',
  Surgery: 'ቀዶ ጥገና',
  'Clear all': 'Clear all',
  Empty:
  ...
  'Use your personal data':
    'At Ethiolab, we attach great importance to privacy issues and are committed to protecting the personal data of our users. Learn more about how we care and use your personal data in the',
  ...
  Price: 'Price',
  Subscribe: 'ደንበኛ ልሁን',
  'Subscribe to Newsletters': 'የመጽሔታችን ደንበኛ ይሁኑ',
