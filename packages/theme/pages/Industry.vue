<template>
  ...
  <div class="shadow-[3px_3px_10px_0_rgba(0,0,0,0.3)] rounded-xl hidden md:block bg-white border-white ">
  ...
  <h2 class="sf-heading__title font-medium text-4xl font-sans text-secondary">
  {{ industryName }}
  </h2>
  <div
