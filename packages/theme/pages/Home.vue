    ...
    <div id="home">
      ...
      <div class="grid grid-cols-12 gap-4 mt-3 py-6">
        ...
        <div class="md:col-span-9 col-span-12 md:ml-3">
          ...
          <LazyHydrate when-visible>
            <div
              class="flex flex-wrap gap-4 mb-4 mt-3 place-content-center md:place-content-start"
            >
              <div
                v-for="(product, i) in this.products"
                :key="i"
                class="rounded-lg drop-shadow-lg product-card w-40 md:w-48"
              >
                <SfProductCard
