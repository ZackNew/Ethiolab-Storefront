            ...
            <div class="field">
                <h4 class="px-10 py-6 uppercase font-bold">Returning Customers</h4 >
                    ...
                    <div class="m-8">
                     ...
                     <div class="m-8">
                        <span class=" text-dark_gray text-sm font-bold mb-2" for="username">
                            ORGANIZATION NAME
                        </span>
                        <input class="shadow appearance-none border border-primary w-1/4 py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="username" type="text" >
                     
                      <input
            
                        type="checkbox"
                        name="categories"
                        class="ml-8 t-4 w-6 h-6"
                        :checked="false"
                         />

                     
                         <span class=" text-dark_gray text-sm font-bold mb-2 "> INDIVIDUAL</span>
                     ...
                     <div class="m-8">
                        <!-- <label class="block text-dark_gray text-sm font-bold mb-2" for="username"> -->
                           <span class=" text-dark_gray text-sm font-bold mb-2">  *Country</span>
                        <!-- </label> -->
                        <select class=" text-sm font-bold mb-2 w-1/6 border border-primary">
                            ...
                            <span class=" text-dark_gray text-sm font-bold mb-2 ml-4">  *City</span>

                            <input class="shadow appearance-none border border-primary h-6  w-1/6 py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="username" type="text" >
                          
                          
                     </div>

                     <div class="m-8">
                                  <span class=" text-dark_gray text-sm font-bold mb-2 ">  STATE </span>

                            <input class="shadow appearance-none border border-primary h-6  w-1/4 py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="username" type="text" >

                            <span class=" text-dark_gray text-sm font-bold mb-2 ml-4 ">  STREET ADDRESS </span>
                     ...
                     <div class="m-8">
                        <span class=" text-dark_gray text-sm font-bold mb-2">  *JOB FUNCTION</span>
                        <!-- </label> -->
                        <select class=" text-sm font-bold mb-2 ml-4 w-1/2 h-8 border border-primary">
                                ...
                                <option value="Adminstrative">Excutive/Director</option>
                                <option value="Adminstrative">Healthcare Professional</option>
                                ...
                                <option value="Adminstrative">Operations/Plant Management</option>
                                <option value="Adminstrative">Owner</option>
                                <option value="Adminstrative">Production Maintenance</option>
                                <option value="Adminstrative">Production Management</option>
                                <option value="Adminstrative">Quality Assurance/Control</option>
                     ...
                     <input
                        ...
                        :checked="true"
                         ...
                         <span class=" text-dark_gray text-sm font-bold mb-2 "> Sign up to receive the latest news, Events & Offers</span>

                         <div class="m-8">
                            <button class="bg-secondary text-white w-1/3 h-16 font-bold mb-8"> REGISTER</button>    
