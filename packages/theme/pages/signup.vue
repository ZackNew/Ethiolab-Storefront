                ...
                <h4 class="px-10 py-6 uppercase font-bold">Returning Customers</h4 >
                  ...
                  <ValidationObserver
                        ...
                        <form @submit.prevent="handleSubmit(handleFormSubmit)">
                                            <div class="m-8">
                                            <label class="block text-dark_gray text-sm font-bold mb-2" for="email">
                                        ...
                                        <div class="m-8">
                                            <label class="block text-dark_gray text-sm font-bold mb-2" for="confirmEmail">
                                        ...
                                        <div class="m-8">
                                            <label class="block text-dark_gray text-sm font-bold mb-2" for="password">
                                                *PASSWORD
                                            </label>
                                        ...
                                        <div class="m-8">
                                            <label class="block text-dark_gray text-sm font-bold mb-2" for="confirmPassword">
                                                *CONFIRM PASSWORD
                                            </label>
                                        ...
                                        <div class="m-8">
                                            <label class="block text-dark_gray text-sm font-bold mb-2" for="firstName">
                                                *FIRST NAME
                                            </label>
                                        ...
                                        <div class="m-8">
                                            <label class="block text-dark_gray text-sm font-bold mb-2" for="lastName">
                                            *LAST NAME
                                            </label>
                                        ...
                                        <div class="m-8">
                                            <label class="block text-dark_gray text-sm font-bold mb-2" for="phoneNumber">
                                                *PHONE NUMBER
                                            </label>
                                        ...
                                        <div class="grid grid-cols-2"> 
                                            <div class="col-span-1"> 
                                                <div class="m-8">
                                                    <div class=" text-dark_gray text-sm font-bold mb-2 "> ORGANIZATION</div>
                                            ...
                                            <div v-if="isOrganization"> 
                                                    <div class=" text-dark_gray text-sm font-bold mb-2" for="company">
                                                            ORGANIZATION NAME
                                                    </div>
                                                ...
                                                <div class="m-8">
                                                    <div class=" text-dark_gray text-sm font-bold mb-2">  *Country</div>
                                            ...
                                            > 
                                                ...
                                                <div class="m-8">
                                                    <div class=" text-dark_gray text-sm font-bold mb-2" for="state">
                                                    STATE
                                                    </div>
                                            ...
                                            <SfInput
                                                ...
                                                />
                                                    ...
                                                    <div class="m-8">
                                                    <div class=" text-dark_gray text-sm font-bold mb-2" for="city">
                                                        CITY
                                                    </div>
                                            ...
                                            <SfInput
                                                ...
                                                <div class="m-8">
                                                    <div class=" text-dark_gray text-sm font-bold mb-2" for="street">
                                                        STREET ADDRESS
                                                    </div>
                                        ...
                                        <div class="m-8">
                                            <label class="block text-dark_gray text-sm font-bold mb-2" for="tin">
                                                TIN
                                            </label>
                                        ...
                                        <div class="m-8">
                                            <label class="block text-dark_gray text-sm font-bold mb-2" for="fax">
                                                FAX
                                            </label>
                                        ...
                                        <!-- <ValidationProvider
                                            ...
                                            <div class=" justify-center flex mt-8">
                                                <button class="bg-secondary text-white w-1/3 h-16 font-bold mb-8 but" type="submit"> REGISTER</button>    
                                            </div>
