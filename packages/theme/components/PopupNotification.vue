      ...
      <template #modal-bar>
        <div class="flex">
          <div class="lg:p-8 mx-3 my-auto">
            <div class="uppercase tracking-wide text-5xl text-indigo-500 font-semibold  text-gray-800">get <span
                class="text-[#a6c76c]">25 %</span> off
            </div>
            <p class="mt-4 max-w-md text-slate-500" v-html="popupContent.title || 'kirubel'"></p>
            <div class="mt-3">
